<div class="special">
	<h2 class="nocap">Monthly Special:  SPECIAL DESCRIPTION HERE</h2>

	<p><img class="stock" src="/images/stock/pillows.jpg" /> Nunc ultricies risus non tortor dapibus semper. Donec varius lacinia enim, non molestie quam porttitor vitae. Curabitur felis ipsum, varius quis sagittis id, feugiat in nunc. Sed a ornare justo. Integer sit amet justo tincidunt sapien ultrices semper. Nulla hendrerit fermentum urna sit amet facilisis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Vivamus quis ipsum sed odio elementum feugiat sed vitae dui. In ac nulla quam, id accumsan dui. Quisque varius consequat lectus, id aliquet elit lacinia id.</p>

	<a class="more">Find out more</a>
</div>

<div class="special">
	<h2 class="nocap">Monthly Special 2</h2>

	<p><img class="stock right" src="/images/stock/pool2.jpg" /> Nunc ultricies risus non tortor dapibus semper. Donec varius lacinia enim, non molestie quam porttitor vitae. Curabitur felis ipsum, varius quis sagittis id, feugiat in nunc. Sed a ornare justo. Integer sit amet justo tincidunt sapien ultrices semper. Nulla hendrerit fermentum urna sit amet facilisis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Vivamus quis ipsum sed odio elementum feugiat sed vitae dui. In ac nulla quam, id accumsan dui. Quisque varius consequat lectus, id aliquet elit lacinia id.</p>
